	...
	<main role="navigation" class="content-wrapper narrow">
		<span class="tag">2005 &ndash; 2006</span>
			...
			<ul class="list-columns">
				...
				<li>Jessie A. Tong</li>
				<li>Yochiro Yoda</li>
				<li>Hirokazu Fukawa</li>
				<li>James Jack</li>
				<li>Evri Kwong</li>
				<li>John Lavery</li>
				<li>Jawshing Arthur Liou</li>
				<li>Jaye Rhee</li>
			...
			<ul class="list-columns">
				...
				<li>Adger W. Cowans</li>
				<li>Eun Young Choi</li>
				<li>Sung Ho Choi</li>
				<li>Julia Cowing</li>
				<li>Pedro Elias Cruz-Castro</li>
				<li>Kelly Darr</li>
				<li>Barbara Ellmann</li>
				<li>Edward Fausty</li>
				<li>Walter Field</li>
				<li>Fred Fleisher</li>
				<li>Ralph Raphael Fleming</li>
				<li>Kay Gordon</li>
				<li>Rebecca Goyette</li>
				<li>Steven Gwon</li>
				<li>Kenji Hirata</li>
			...
			<h6>Participating artists:</h6>
			<ul class="list-columns">
				<li>Ernest Concepcion</li>
				<li>Nathelie Pham</li>
				<li>Eugenie Tung</li>
				<li>Wayne Liu</li>
				<li>Kim Tran</li>
			</ul>
			<p><span class="date">June 23, 2005</span></p>
			<h6>Participating artists:</h6>
			<ul class="list-columns">
				<li>Asma A. Shikoh</li>
				<li>Avani Patel</li>
				<li>Robin Gaynes-Bachman</li>
				<li>Victoria Law</li>
				<li>Avantika Bawa</li>
			</ul>
			<p><span class="date">June 30, 2005</span></p>
			<h6>Participating artists:</h6>
			<ul class="list-columns">
				<li>Haegeen Kim</li>
				<li>Yamini Nayar</li>
