...
<div class="page-wrapper">
	...
	<main class="content-wrapper narrow" role="main">
		<span class="tag">1992 &ndash; 1993</span>
			...
			<ul class="list-columns">
				...
				<li>Allen, John Amoros, Grimanesa </li>
				...
				<li>Lascari, Anna </li>
				<li>Lee, Bing </li>
				<li>Lee, Gerald Ling Ling (Billy Harlem) </li>
				<li>Lipski, Donald </li>
				<li>Lum, Mary </li>
				<li>Mei, Dean-I </li>
				<li>Morr, Erik </li>
			...
			<ul class="list-columns">
				...
				<li>Hee-Sook Kim</li>
				<li>Hyun-Mi Yoo</li>
				<li>Jacqueline Chang</li>
				<li>May-Ling Chang </li>
				<li>Sungmi Naylor	</li>
				<li>Yoshiko Shimada</li>
				<li>Ava Hsueh </li>
				<li>Sowon Kwon </li>
				<li>Ellen Pau</li>
			</ul>
			...
			<p>Extensive documentation accompanied the exhibition on issues gathered by LEAP and amplified by Lorinda Chen with information on NYC. Portions were published in Artspiral. Curated by Robert Lee. Held at Court House in New York, NY.</p>
			<h6>Participating artists:</h6>
			<ul class="list-columns">
				<li>Rashid Arshed</li>
				<li>Kip Fulbeck</li>
				...
				<li>Marcelo Krasilcic</li>
				<li>Vijay Kumar</li>
				<li>Dinh Le</li>
				<li>Sang Kyoon Noh</li>
