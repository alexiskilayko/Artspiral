...
<div class="page-wrapper">
	...
	<main role="main" class="content-wrapper narrow">
		<h1>About Us</h1>
			...
			<p>Since 1982, the Art Centre’s Visual Arts <a href="/exhibitions.php">Exhibitions Program</a> continues to be active today, occasionally mounting exhibitions and producing catalogues, despite the closing of its formal gallery after 25 years. It includes a permanent research archive of over 1,600 entries documenting the history of Asian American artists in the United States since 1945. From 1988 to 1993, the Art Centre published seven issues of the journal <i>Artspiral</i> in traditional print, with <a href="/artspiral.php">one issue published online</a>, which focused on contemporary topics in the arts.  Today, the discourse continues, on <a href="http://artspiral.blogspot.com">the Blog</a>, <a href="https://www.flickr.com/photos/asianamericanartscentre/">Flickr</a>, <a href="https://www.facebook.com/AsianAmericanArtsCentre">Facebook</a> and etc. at the nexus of contemporary, traditional, historical, and local issues in the arts. </p>

			<p>In 2006, the Art Centre received a grant from the Lower Manhattan Development Corporation (LMDC) to create a professional digital archive of Asian/Asian American contemporary visual artists: <a href="http://artasiamerica.org">artasiamerica</a>. It is a historical image and document archive of Asian visual culture in the United States from 1945 to the present. It draws its artists primarily from the record of exhibitions mounted by AAAC, selecting artists whose artwork is the most exemplary of the themes that compose the subject of Asian American art.  Accessible to a national and international public, it is a high-quality research tool available globally to scholars, historians, curators, artists, as well as an educational resource for college and high school students, teachers, and community members.</p>
