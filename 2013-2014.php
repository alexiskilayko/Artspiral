	...
	<main role="main" class="content-wrapper narrow">
		<span class="tag">2013 &ndash; 2014</span>
			...
			<ul class="list-columns">
				...
				<li>John Duff</li>
				<li>“Deng”</li>
				<li>Onofre Fraticelli</li>
				<li>Leon Golub</li>
				<li>Han Khiang Hei</li>
				...
				<li>Rumiko Tsuda/Daniel Georges</li>
				<li>Dolly Unithan</li>
				<li>Tom Utter</li>
				<li>Martin Wong</li>
				<li>Chadio Elmhurst</li>
				<li>Sofia Zezmer</li>
				<li>Zhang Hongtu</li>
			</ul>
	</main>
