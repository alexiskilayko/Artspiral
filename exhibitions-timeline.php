...
<body class="exhibitions exhibitionstimeline">
<div class="page-wrapper">
	...
	<section class="timeline">
		...
		<div class="timeline-block">
			<div class="timeline-circle">	</div>
			<a class="timeline-content" href="/2009-2010.php">
		...
		<div class="timeline-block">
			<div class="timeline-circle">	</div>
			<a class="timeline-content" href="/2008-2009.php">
		...
		<div class="timeline-block">
			...
			<a class="timeline-content" href="/2005-2006.php">
				...
				<ul>
					...
					<li>Tibetan Thangka Paintings</li>
					<li>Detained</li>
					<li>Chinatown Work 2006</li>
					<li>New York Eviction Blues II</li>
		...
		<div class="timeline-block">
			...
			<a class="timeline-content" href="/2001-2002.php">
				...
				<ul>
					<li>Mitochondria Emancipation: 11th AAAC Annual Exhibition</li>
					<li>17 Squares: Long Nguyen at Mid-Career</li>
		...
		<div class="timeline-block">
			...
			<a class="timeline-content" href="/1998-1999.php">
				...
				<ul>
					<li>A Continuing Struggle: The Legacy of War in Cambodia</li>
					<li>The Day and Night Transparent: 8th AAAC Annual Exhibition</li>
		...
		<div class="timeline-block">
			...
			<a class="timeline-content" href="/1992-1993.php">
				<span class="date">1992 – 1993</span>
				<ul>
					<li>CHINA: June 4 1989</li>
		...
		<div class="timeline-block">
			<div class="timeline-circle">	</div>
			<a class="timeline-content" href="/1989-1990.php">
				<span class="date">1989 – 1990</span>
				<ul>
					<li>Aurora</li>
					<li>Witnesses</li>
					<li>CHINA: June 4 1989</li>
		...
		<div class="timeline-block">
			...
			<a class="timeline-content" href="/1987-1988.php">
				...
				<ul>
					<li>Confucius Life Story</li>
					<li>One Eye or Two</li>
					<li>From Cambodia to the Bronx</li>
		...
		<div class="timeline-block">
			...
			<a class="timeline-content" href="/1985-1986.php">
				<span class="date">1985 – 1986</span>
				<ul>
					<li>Roots to Reality: A Collaboration</li>
					<li>Ming Chip Fung: The Seal 1975-1985</li>
					<li>New Year’s Embroidery</li>
					<li>The City</li>
					<li>Orientalism</li>
		...
		<div class="timeline-block">
			...
			<a class="timeline-content" href="/1983-1984.php">
				...
				<ul>
					<li>In the Spirit of Dunhuang: Studies by Zhang Hongtu</li>
