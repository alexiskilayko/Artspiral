...
<div class="page-wrapper">
	...
	<main class="content-wrapper narrow" role="main">
		<span class="tag">1998 &ndash; 1999</span>

			<h2>A Continuing Struggle: The Legacy of War in Cambodia</h2>
        <p><span class="date">September 1 – 15, 1998</span></p>
        <p>An exhibition of photographs of Leah Melnick's work as a college student documenting the Cambodian refugee community in the Bronx, and later, her humanitarian work in Bosnia. </p>
        ...
        <ul class="list-columns">
          <li>Leah Melnick</li>
			...
			<h2>The Day and Night Transparent: 8th AAAC Annual Exhibition</h2>
			<p><span class="date">October 16 – November 21, 1998</span></p>
      ...
      <h2>Six O'Clock Observed: Photos by Toyo Tsuchiya</h2>
       ...
       <ul class="list-columns"></ul>
			...
			<p>A free sculptural performance held in Bryant Park, 42nd Street & 6th Ave in NYC. As ice melts a great white ball rises…. A collaboration with a Chinese poet, an American poet, and a sculptor, with additional four women performers.  Collages of multi-layered, multi-faceted aspects in communcation, combine visual elements and three spoken languages – Chinese, Taiwanese & English – to foreground human desire as a process of translation, transplantation, and transformation.
Sponsored by Contemporary Arts International in Boston. Administered by AAAC.</p>
			<h6>Participating Artists:</h6>
			<ul class="list-columns">
				<li>Meng Lang</li>
				<li>Yin Peet</li>
				<li>Leonard Schwarts</li>
			</ul>
