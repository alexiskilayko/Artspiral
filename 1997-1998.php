	...
	<main class="content-wrapper narrow" role="main"><!--HERE -->
		<span class="tag">1997 &ndash; 1998</span>
			...
			<ul class="list-columns">
                ...
                <li>Kyung Chung</li>
                <li>May Goldman</li>
                <li>Bonnie McCandless</li>
                <li>Rachel Randolph</li>
                <li>Sara Wicks</li>
                <li>Hung Chan Lin</li>
            ...
            <p>Organized by Sewon Oh, Danielle DiMonda & Robert Lee.</p>
            <h6>Participating Artists:</h6>
            <ul class="list-columns">
                <li>Salma Arastu</li>
                <li>Sukran Aziz </li>
                <li>Barbara Bartholomew</li>
                <li>Charles DiConstanza</li>
                <li>Shun Endo</li>
